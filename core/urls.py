...
urlpatterns = [
    ...
    # Debug
    path("debug-sesion/", views.debug_sesion, name="debug_sesion"),
    ...
    path("dimensionamiento/dimensionamiento/", views.dimensionamiento_dimensionamiento, name="dimensionamiento_dimensionamiento"),
    ...
    path("recursos/conceptos/alta/", views.recursos_alta_concepto, name="recursos_alta_concepto"),
    path("recursos/conceptos/modificacion/", views.recursos_modificacion_concepto, name="recursos_modificacion_concepto"),
    path("recursos/tablas/alta/", views.recursos_alta_tabla, name="recursos_alta_tabla"),
    path("recursos/tablas/modificacion/", views.recursos_modificacion_tabla, name="recursos_modificacion_tabla"),
